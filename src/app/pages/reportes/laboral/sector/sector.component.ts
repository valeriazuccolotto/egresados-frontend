...
import { opcionesGraficaCircular } from '../../../../utils/graficas-chart-options.util';
...
export class SectorComponent implements OnInit, OnDestroy {
  ...
  async descargar(): Promise<void> {
    await descargarGraficaPdfPorId('chart', 'Sector laboral', 'sector-laboral.pdf', 'Distribución de egresados por sector de trabajo');
  }
