...
export class ModalidadLaboralComponent implements OnInit, OnDestroy {
  ...
  construir() {
    ...
    const labels = [...ETIQUETAS_MODALIDAD_LABORAL];
    const values = contarPorCampo(datos, 'modalidadTrabajo', ETIQUETAS_MODALIDAD_LABORAL);
  ...
  async descargar(): Promise<void> {
    await descargarGraficaPdfPorId('chart', 'Modalidad de trabajo', 'modalidad-laboral.pdf', 'Presencial, remoto o híbrido');
  }
